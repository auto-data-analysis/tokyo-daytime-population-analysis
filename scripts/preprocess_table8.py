...
fact_h27.to_csv(output_dir / "fact_industry_workers_2015.csv", index=False)
fact_r2.to_csv(output_dir / "fact_industry_workers_2020.csv", index=False)
fact_all.to_csv(output_dir / "fact_industry_workers.csv", index=False)
print("\n保存完了")
