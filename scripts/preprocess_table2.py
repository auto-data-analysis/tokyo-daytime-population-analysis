...
fact_h27.to_csv(
    output_dir / "fact_population_by_status_2015.csv", index=False, encoding="utf-8"
)
fact_r2.to_csv(
    output_dir / "fact_population_by_status_2020.csv", index=False, encoding="utf-8"
)
fact_all.to_csv(
    output_dir / "fact_population_by_status.csv", index=False, encoding="utf-8"
)
print("\n保存完了")
